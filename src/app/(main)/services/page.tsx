            ...
            {services.map((svc, idx) => (
              <article key={svc.id} className={`svc-item ${idx % 2 === 1 ? 'svc-item--reverse' : ''}`}>
                <div className="svc-item-icon-wrap">
                  <div className="svc-item-icon" aria-hidden="true">{svc.icon}</div>
                </div>
      ...
      <section className="svc-bundle section-gray">
        <div className="container">
          <div className="svc-bundle-card">
            ...
            <p>All four components built together as one integrated system. This is how we get the best results — not individual services stitched together, but a complete system designed to work as one.</p>
            <ul className="svc-bundle-list">
              <li><CheckCircle2 size={18} aria-hidden="true" /> Website design &amp; development</li>
              <li><CheckCircle2 size={18} aria-hidden="true" /> SEO &amp; Answer Engine Optimisation</li>
              <li><CheckCircle2 size={18} aria-hidden="true" /> Google Ads &amp; Meta Ads management</li>
              <li><CheckCircle2 size={18} aria-hidden="true" /> Growth automation &amp; reporting</li>
            </ul>
            <Link href="/audit" className="btn btn-primary">Get Free Growth Audit</Link>
          </div>
        </div>
      </section>
    </div>
